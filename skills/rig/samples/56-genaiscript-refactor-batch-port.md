...
const refactorOne = agent({ name: "refactorOne", model: "mini", instructions: "Suggest one minimal metadata cleanup for a rig sample.", output: s.object({ file: s.string, change: s.string }) });
